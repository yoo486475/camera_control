...
class Number_and_Detector():
    def __init__(self, model_count_people_path, model_hitter_side_path):
        self.model_count_people = YOLO(model_count_people_path)
        self.model_hitter_side = YOLO(model_hitter_side_path)

    def count_number(self, video_path):
        ...
        if not camVideo.isOpened():
            ...
            while camVideo.isOpened():
                ...
                cf_results = self.model_count_people(CFImage, show=True)[0]
                    ...
                    if detected_people_count == 4:
                        ...
                        if has_run == False:
                            ...
                            if detected_count['count_time'] == 3:
                                print("Four people")
                                hitter_sides = self.model_hitter_side(CFImage, show=True)[0]
...
count = Number_and_Detector(
    model_count_people_path = "./yolov8n.pt",
    model_hitter_side_path = "./yolov8n.pt"
)

count.count_number(video_path = "./video/101943--av-1.mp4")